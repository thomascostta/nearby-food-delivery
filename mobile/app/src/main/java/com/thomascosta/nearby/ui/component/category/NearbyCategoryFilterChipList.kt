...
import com.thomascosta.nearby.data.model.mock.mockCategories
...
fun NearbyCategoryFilterChipList(
    ...
    LaunchedEffect(key1 = selectedCategoryId) {
        val selectedCatogoryOrNull = categories.find { it.id == selectedCategoryId }
        selectedCatogoryOrNull?.let {
